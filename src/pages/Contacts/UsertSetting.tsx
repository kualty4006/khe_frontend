...
import avatarKualty from "../../assets/images/users/juan.jpeg";
            ...
            <Card>
              <CardBody>
                ...
                <div className="text-center">
                  ...
                  <h5 className="font-size-16 mb-1">Juan Restrepo</h5>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <label
                            ...
                            htmlFor="gen-info-change-password"
                          >
                            Change Password?
                          </label>
                        </div>
                    ...
                    <CardBody>
                      ...
                      <Row>
                        ...
                        <div className="col-md-6">
                          <div className="mb-md-0">
                            <label
                              htmlFor="contact-info-location-input"
                              className="form-label"
                            >
                              Location
                            </label>
                  ...
                  <div className="card border shadow-none">
                    ...
                    <CardBody>
                      <Row>
                        ...
                        <Col lg={6}>
                          <div className="mb-3">
                            <label htmlFor="workexperience-companyname-input">
                              Company name
                            </label>
                            <input
                              type="text"
