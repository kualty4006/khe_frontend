...
import logoKualty from "../../assets/images/kualty.png";
...
const Login = ({ props }: LoginProps) => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      email: "juan.restrepo@kualty.com" || "",
      password: "12345" || "",
    },
            ...
            <Row className="justify-content-center my-auto">
              <Col md={8} lg={6} xl={4}>
                <div className="text-center py-5">
                  ...
                  <div className="mb-4">
                    <h5>Welcome Back!</h5>
                    <p>Sign in to continue to Kualty.</p>
                  </div>
                  {error && error ? (
            ...
            <Row>
              <Col xl={12}>
                <div className="text-center text-muted p-4">
                  <p className="mb-0">
                    &copy; {new Date().getFullYear()} Kualty. Crafted with{" "}
                    <i className="mdi mdi-heart text-danger"></i> by Alejandro
                    and Andres
                  </p>
                </div>
              </Col>
