              ...
              <CardBody>
                <div className="d-flex">
                  <div className="flex-grow-1 me-2 flex-wrap">
                    <h5 className="font-size-15 mb-1"><Link to="projects-overview" className="text-body">{name}</Link></h5>
                  ...
                  <Col xl={3} sm={6}>
                    <div className="border p-3 h-100">
                      <div>
                        ...
                        <div className="badge badge-primary-subtle font-size-12">{category}</div>
                      </div>
                    </div>
                  </Col>
                  <Col xl={3} sm={6}>
