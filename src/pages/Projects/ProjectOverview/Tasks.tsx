              ...
              <table className="table align-middle table-nowrap mb-0">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span className="badge badge-primary-subtle font-size-12">
                        Open
                      </span>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span className="badge badge-warning-subtle font-size-12">
                        Inprogress
                      </span>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span className="badge badge-success-subtle font-size-12">
                        Completed
                      </span>
                    </td>
                    <td>
