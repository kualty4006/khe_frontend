                        ...
                        <Col xl={6}>
                            <Card>
                                <CardHeader className="justify-content-between d-flex align-items-center">
                                    ...
                                    <p className="m-0 badge btn-primary-subtle py-2">Dashonic Only</p>
                                </CardHeader>
                                <CardBody>
                                    ...
                                    <div className="p-3 mb-2 bg-primary text-white opacity-75">.bg-opacity-75</div>
                                    <div className="p-3 mb-2 bg-primary text-white opacity-50">.bg-opacity-50</div>
                                    <div className="p-3 mb-2 bg-primary text-white opacity-25">.bg-opacity-25</div>
                                </CardBody>
                            </Card>
                        </Col>
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="p-3 mb-2 bg-primary bg-gradient text-white opacity-75">.bg-opacity-75 .bg-gradient</div>
                                    <div className="p-3 mb-2 bg-primary bg-gradient text-white opacity-50">.bg-opacity-50 .bg-gradient</div>
                                    <div className="p-3 mb-2 bg-primary bg-gradient text-white opacity-25">.bg-opacity-25 .bg-gradient</div>
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
                        ...
                        <Col xl={6}>
                            <Card>
                                <CardHeader className="justify-content-between d-flex align-items-center">
                                    ...
                                    <a href="https://getbootstrap.com/docs/5.2/utilities/borders/#border-color" className="btn btn-sm btn-secondary-subtle">Docs <i className="mdi mdi-arrow-right align-middle"></i></a>
                                </CardHeader>
                                <CardBody>
                                    <div className="d-flex flex-wrap gap-2">
                        ...
                        <Col xl={4}>
                            <div className="card card-h-100">
                                <CardHeader className="justify-content-between d-flex align-items-center">
                                    ...
                                    <Link to="https://getbootstrap.com/docs/5.0/utilities/flex/#enable-flex-behaviors" target="_blank" rel="noreferrer" className="btn btn-sm btn-secondary-subtle">Docs <i className="mdi mdi-arrow-right align-middle"></i></Link>
                                </CardHeader>
                                <CardBody>
                        ...
                        <Col xl={4}>
                            ...
                            <Card>
                                <CardHeader className="justify-content-between d-flex align-items-center">
                                    ...
                                    <Link to="https://getbootstrap.com/docs/5.0/utilities/text/#font-size" target="_blank" rel="noreferrer" className="btn btn-sm btn-secondary-subtle">Docs <i className="mdi mdi-arrow-right align-middle"></i></Link>
                                </CardHeader>
                                <CardBody>
