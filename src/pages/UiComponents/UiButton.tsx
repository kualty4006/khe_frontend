        ...
        <Container fluid>
          ...
          <Row>
            ...
            <Col xl={4}>
              <Card>
                ...
                <CardBody>
                  <div className="d-flex flex-wrap gap-2">
                    <button type="button" className="btn btn-primary-subtle">
                      Primary
                    </button>
                    <button type="button" className="btn btn-secondary-subtle">
                      Secondary
                    </button>
                    <button type="button" className="btn btn-success-subtle">
                      Success
                    </button>
                    <button type="button" className="btn btn-info-subtle">
                      Info
                    </button>
                    <button type="button" className="btn btn-warning-subtle">
                      Warning
                    </button>
                    <button type="button" className="btn btn-danger-subtle">
                      Danger
                    </button>
                    <button type="button" className="btn btn-purple-subtle">
                      Purple
                    </button>
                    <button type="button" className="btn btn-dark-subtle">
                      Dark
                    </button>
                    <button type="button" className="btn btn-light-subtle">
                      Light
                    </button>
                  </div>
                </CardBody>
              ...
              <Card>
                ...
                <CardBody>
                  <div className="d-flex flex-wrap gap-2">
                    <button
                      type="button"
                      className="btn btn-primary-subtle btn-rounded"
                    >
                      Primary
                    </button>
                    <button
                      type="button"
                      className="btn btn-secondary-subtle btn-rounded"
                    >
                      Secondary
                    </button>
                    <button
                      type="button"
                      className="btn btn-success-subtle btn-rounded"
                    >
                      Success
                    </button>
                    <button
                      type="button"
                      className="btn btn-info-subtle btn-rounded"
                    >
                      Info
                    </button>
                    <button
                      type="button"
                      className="btn btn-warning-subtle btn-rounded"
                    >
                      Warning
                    </button>
                    <button
                      type="button"
                      className="btn btn-danger-subtle btn-rounded"
                    >
                      Danger
                    </button>
                    <button
                      type="button"
                      className="btn btn-purple-subtle btn-rounded"
                    >
                      Purple
                    </button>
                    <button
                      type="button"
                      className="btn btn-dark-subtle btn-rounded"
                    >
                      Dark
                    </button>
                  </div>
          ...
          <Row>
            <Col xl={4}>
              <Card>
                <CardHeader className="justify-content-between d-flex align-items-center">
                  <CardTitle className="h4">Vertical Variation & Nesting</CardTitle>
                  <Link
                    to="//reactstrap.github.io/components/buttons/"
                    target="_blank"
                    rel="noreferrer"
