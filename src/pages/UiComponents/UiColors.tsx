              ...
              <Card>
                <CardBody>
                  <div className="bg-light rounded-3 text-center overflow-hidden">
                    <Row className="g-0">
                      <Col xl={6}>
                        <div className="bg-primary-subtle" style={{ height: "90px" }}></div>
                      </Col>
                      <Col xl={6}>
              ...
              <Card>
                <CardBody>
                  <div className="bg-light text-center rounded-3 overflow-hidden">
                    <Row className="g-0">
                      <Col xl={6}>
                        <div className="bg-success-subtle" style={{ height: "90px" }}></div>
                      </Col>
                      <Col xl={6}>
              ...
              <Card>
                <CardBody>
                  <div className="bg-light text-center rounded-3 overflow-hidden">
                    <Row className="g-0">
                      <Col xl={6}>
                        <div className="bg-warning-subtle" style={{ height: "90px" }}></div>
                      </Col>
                      <Col xl={6}>
              ...
              <Card>
                <CardBody>
                  <div className="bg-light text-center rounded-3 overflow-hidden">
                    <Row className="g-0">
                      <Col xl={6}>
                        <div className="bg-danger-subtle" style={{ height: "90px" }}></div>
                      </Col>
                      <Col xl={6}>
              ...
              <Card>
                <CardBody>
                  <div className="bg-light text-center rounded-3 overflow-hidden">
                    <Row className="g-0">
                      <Col xl={6}>
                        <div className="bg-info-subtle" style={{ height: "90px" }}></div>
                      </Col>
                      <Col xl={6}>
              ...
              <Card>
                <CardBody>
                  <div className="bg-light text-center rounded-3 overflow-hidden">
                    <Row className="g-0">
                      <Col xl={6}>
                        <div className="bg-secondary-subtle" style={{ height: "90px" }}></div>
                      </Col>
                      <Col xl={6}>
              ...
              <Card>
                <CardBody>
                  <div className="bglight text-center rounded-3 overflow-hidden">
                    <Row className="g-0">
                      <Col xl={6}>
                        <div className="bg-light-subtle" style={{ height: "90px" }}></div>
                      </Col>
                      <Col xl={6}>
