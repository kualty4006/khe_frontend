          ...
          <Row>
            ...
            <Col xl={4}>
              <Card>
                ...
                <CardBody>
                  <Badge color="link" pill className="badge-primary-subtle">
                    Primary
                  </Badge>{" "}
                  <Badge color="link" pill className="badge-secondary-subtle">
                    Secondary
                  </Badge>{" "}
                  <Badge color="link" pill className="badge-success-subtle">
                    Success
                  </Badge>{" "}
                  <Badge color="link" pill className="badge-info-subtle">
                    Info
                  </Badge>{" "}
                  <Badge color="link" pill className="badge-warning-subtle">
                    Warning
                  </Badge>{" "}
                  <Badge color="link" pill className="badge-purple-subtle">
                    Purple
                  </Badge>{" "}
                  <Badge color="link" pill className="badge-danger-subtle">
                    Danger
                  </Badge>{" "}
                  <Badge color="link" pill className="badge-dark-subtle">
                    Dark
                  </Badge>{" "}
                  <Badge color="link" pill className="badge-light-subtle">
                    Light
                  </Badge>{" "}
                </CardBody>
              </Card>
              ...
              <Card>
                ...
                <CardBody>
                  <Badge
                    color="link"
                    pill
                    className="rounded-pill badge-primary-subtle"
                  >
                    Primary
                  </Badge>{" "}
                  <Badge
                  ...
                  <Badge
                    color="link"
                    pill
                    className="rounded-pill badge-success-subtle"
                  >
                    Success
                  </Badge>{" "}
                  <Badge
                    color="link"
                    pill
                    className="rounded-pill badge-info-subtle"
                  >
                    Info
                  </Badge>{" "}
                  <Badge
                    color="link"
                    pill
                    className="rounded-pill badge-warning-subtle"
                  >
                    Warning
                  </Badge>{" "}
                  <Badge
                    color="link"
                    pill
                    className="rounded-pill badge-purple-subtle"
                  >
                    Purple
                  </Badge>{" "}
                  <Badge
                    color="link"
                    pill
                    className="rounded-pill badge-danger-subtle"
                  >
                    Danger
                  </Badge>{" "}
                  <Badge
                    color="link"
                    pill
                    className="rounded-pill badge-dark-subtle"
                  >
                    Dark
                  </Badge>{" "}
                  <Badge
                    color="link"
                    pill
                    className="rounded-pill badge-light-subtle"
                  >
                    Light
                  </Badge>{" "}
                </CardBody>
                ...
                <CardBody>
                  <div className="d-flex flex-wrap gap-3">
                    ...
                    >
                      ...
                      <span className="position-absolute top-0 start-100 translate-middle badge border border-light rounded-circle bg-success p-">
                        <span className="visually-hidden">unread messages</span>
                      </span>
                    </button>
                  </div>
