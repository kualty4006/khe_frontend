                ...
                <Card>
                  ...
                  <ul className="message-list">
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          <span className="badge badge-warning-subtle me-2">
                            Freelance
                          </span>
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          <span className="badge badge-info-subtle me-2">Support</span>Off on Thursday -{" "}
                          <span className="teaser">
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          <span className="badge badge-primary-subtle me-2">Social</span>
                    ...
                    <li className="unread">
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          <span className="badge badge-success-subtle me-2">Family</span>
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          <span className="badge badge-danger-subtle me-2">Friends</span>
                          Weekend on Revibe – {" "}
                          <span className="teaser">
                    ...
                    <li className="unread">
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          <span className="badge badge-info-subtle me-2">Support</span>
                          Home again! – {" "}{" "}
                          <span className="teaser">
