                                    ...
                                    <ul className="list-unstyled mb-0">
                                        ...
                                        <li className="py-3">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="flex-grow-1">
                                                    <p className="text-muted mb-1 font-size-13">E-mail</p>
                                                    ...
                                                    <ul className="list-group list-group-flush">
                                                        <li className="list-group-item py-3 px-0">
                                                            <div className="d-flex align-items-center">
                                                                ...
                                                                <div className="flex-grow-1 overflow-hidden">
                                                                    <h5 className="font-size-14 mb-1 text-truncate"><Link to="#" className="text-body">Beautiful Day with Friends</Link></h5>
                                                        ...
                                                        <li className="list-group-item py-3 px-0">
                                                            <div className="d-flex align-items-center">
                                                                ...
                                                                <div className="flex-grow-1 overflow-hidden">
                                                                    <h5 className="font-size-14 mb-1 text-truncate"><Link to="#" className="text-body">Morning skating with friends</Link></h5>
                                                                    <ul className="list-inline font-size-13 text-muted">
                                                                        <li className="list-inline-item">
                                                                            <Link to="#" className="text-muted">
                                                                                <i className="uil uil-user me-1"></i> Katie
                                                        ...
                                                        <li className="list-group-item py-3 px-0">
                                                            <div className="d-flex align-items-center">
                                                                ...
                                                                <div className="flex-grow-1 overflow-hidden">
                                                                    <h5 className="font-size-14 mb-1 text-truncate"><Link to="#" className="text-body">Project Discussion with Team</Link></h5>
                                                                    <ul className="list-inline font-size-13 text-muted">
                                                                        <li className="list-inline-item">
                                                                            <Link to="#" className="text-muted">
                                                                                <i className="uil uil-user me-1"></i> Katie
                                                        ...
                                                        <li className="list-group-item py-3 px-0">
                                                            <div className="d-flex align-items-center">
                                                                ...
                                                                <div className="flex-grow-1 overflow-hidden">
                                                                    <h5 className="font-size-14 mb-1 text-truncate"><Link to="#" className="text-body">Reading book</Link></h5>
                                                                    <ul className="list-inline font-size-13 text-muted">
                                                                        <li className="list-inline-item">
                                                                            <Link to="#" className="text-muted">
                                                                                <i className="uil uil-user me-1"></i> Katie
                                        ...
                                        <Card>
                                            <CardBody>
                                                ...
                                                <div className="d-flex flex-wrap gap-2 font-size-16">
                                                    <Link to="#" className="badge badge-primary-subtle">Photoshop</Link>
                                                    <Link to="#" className="badge badge-primary-subtle">illustrator</Link>
                                                    <Link to="#" className="badge badge-primary-subtle">HTML</Link>
                                                    <Link to="#" className="badge badge-primary-subtle">CSS</Link>
                                                    <Link to="#" className="badge badge-primary-subtle">Javascript</Link>
                                                    <Link to="#" className="badge badge-primary-subtle">Php</Link>
                                                    <Link to="#" className="badge badge-primary-subtle">Python</Link>
                                                </div>
                                            </CardBody>
                                        </Card>
